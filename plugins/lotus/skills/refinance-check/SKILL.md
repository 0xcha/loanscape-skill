...
```bash
node "${CLAUDE_PLUGIN_ROOT}/core/cost.mjs" --coll <collateral> --borrow <asset> --paying <rate> [--venue aave|prime|spark|morpho|compound|fluid] [--size 50k] [--ltv 60] [--chain ethereum|base|arbitrum]
```
